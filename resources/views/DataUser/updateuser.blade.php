                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="text" class="form-control" id="nip" placeholder="NIP"
                                                    required="required" value="{{ $i['NIP'] }}" name="nip">
                                            </div>
                                        </div>
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="text" class="form-control" id="name" autocomplete="off"
                                                    placeholder="Nama" required="required" value="{{ $i['Name'] }}"
                                                    name="name">
                                            </div>
                                        </div>
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="email" class="form-control" id="email"
                                                    placeholder="E-mail" required="required" value="{{ $i['email'] }}"
                                                    name="email">
                                            </div>
                                        </div>
                                        <div class="mb-3">
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="text" class="form-control" id="jabatan"
                                                    autocomplete="off" placeholder="Jabatan" required="required"
                                                    value="{{ $i['jabatan'] }}" name="jabatan">
                                            </div>
                                        </div>
                                        <div class="mb-3">
